        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-14 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-stone-500 text-xs md:text-sm">
              Connect instantly with our support team. We aim to respond as quickly as possible, usually within one business day.
            </p>
            ...
            <div className="grid gap-4 pt-2">
              ...
              <div className="bg-emerald-950 text-stone-100 rounded-xl p-6 border border-emerald-800 shadow-md flex flex-col justify-between" id="contact-trial-cta-card">
                <div className="space-y-2">
                  <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-emerald-800 text-[10px] text-amber-300 font-bold uppercase tracking-wider font-sans">
                    ★ Priority Session Booking
                  </div>
                  <h3 className="font-sans font-bold text-base text-stone-50">Ready to Book Your Free Trials?</h3>
                  <p className="text-stone-300 text-xs">Skip general questions and submit your scheduling info straight to our coordinator desk.</p>
                </div>
                <button
                  onClick={() => navigate("/free-trial")}
                  className="mt-5 w-full inline-flex items-center justify-center px-4 py-3 rounded-md text-xs font-bold uppercase tracking-wider text-emerald-950 bg-amber-300 hover:bg-amber-400 transition-colors shadow focus:outline-none"
                >
