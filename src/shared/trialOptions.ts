...
export const MAIN_GOAL_OPTIONS = [{ value: "qaida", label: "Learn Qaida" }, { value: "quran-reading", label: "Improve Quran reading" }, { value: "tajweed", label: "Tajweed correction" }, { value: "hifz", label: "Hifz" }, { value: "unsure", label: "Not sure yet" }] as const;
