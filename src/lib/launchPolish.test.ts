...
assert.deepEqual(PRICING.currencies.USD.rates,[29,39,49,59,69,39,49]); assert.deepEqual(PRICING.currencies.GBP.rates,[30,40,45,50,60,35,45]); assert.deepEqual(PRICING.currencies.CAD.rates,[55,70,85,100,115,65,80]); assert.deepEqual(PRICING.currencies.AUD.rates,[60,75,90,100,115,65,80]); assert.deepEqual(PRICING.localeCurrencies,{US:"USD",GB:"GBP",CA:"CAD",AU:"AUD"});
