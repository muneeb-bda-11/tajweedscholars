...
import { SITE_CONFIG, NAVIGATION_LINKS, siteEmails, siteMailto } from "../config/site";
...
export const Footer: React.FC = () => <footer id="app-footer" className="border-t border-emerald-700 bg-emerald-800 text-white/90">
  <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
    <div className="grid gap-9 border-b border-white/20 pb-8 sm:grid-cols-2 lg:grid-cols-4">
      <div><img src="/brand/logo-horizontal-white.svg" alt="Tajweed Scholars" width="1600" height="400" loading="lazy" decoding="async" className="h-auto w-[205px]"/><p className="mt-3 text-sm leading-6">Live, private one-to-one Quran classes for children and adults.</p>
