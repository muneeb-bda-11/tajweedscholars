  ...
  return (
    <div className="relative mx-auto aspect-[16/10] w-full max-w-[34rem] sm:h-[300px] sm:aspect-auto lg:h-[390px]">
      <div className="absolute inset-2 overflow-hidden rounded-[2rem_.85rem_2rem_.85rem] border border-stone-200 bg-emerald-50 shadow-sm">
        {imageAvailable ? (
          <img src="/brand/hero-online-quran-class.webp" width="1200" height="750" alt="Online Quran learning" decoding="async" fetchPriority="high" sizes="(max-width: 640px) calc(100vw - 48px), 544px" className="h-full w-full object-cover object-[50%_25%]" onError={() => setImageAvailable(false)} />
        ) : (
