...
export const HeroLessonVisual: React.FC = () => {
  ...
  return (
    <div className="relative mx-auto aspect-[16/10] w-full max-w-[34rem] sm:h-[300px] sm:aspect-auto lg:h-[390px]">
      <div className="absolute inset-2 overflow-hidden rounded-[2rem_.85rem_2rem_.85rem] border border-stone-200 bg-emerald-50 shadow-sm">
        {imageAvailable ? (
          <img src="/brand/hero-online-quran-class.webp" width="1200" height="750" alt="Illustrative online Quran learning scene" decoding="async" fetchPriority="high" sizes="(max-width: 640px) calc(100vw - 48px), 544px" className="h-full w-full object-cover object-[50%_25%]" onError={() => setImageAvailable(false)} />
        ) : (
          <div className="flex h-full flex-col items-center justify-center px-6 text-center">
            ...
            <p className="mt-3 text-xs font-bold text-stone-700 sm:text-sm">Live private Quran learning</p>
